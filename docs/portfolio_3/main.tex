...
\item \textbf{Deterministische Hardware-Limits:} Um keine verfälschten Ergebnisse durch überzüchtete Entwickler-Hardware zu erhalten, wurde die PostgreSQL-Instanz im Docker-Container strikt limitiert. Dies simuliert eine realistische Cloud-Instanz (z.B. AWS t3.medium) und macht die I/O-Optimierungen erst sichtbar.
\end{itemize}
\newpage
